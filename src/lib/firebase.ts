...
const firebaseConfig = {
  ...
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || "dairymate.firebaseapp.com",
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || "dairymate",
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "dairymate.firebasestorage.app",
